...
const HomeworkThankyouScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    if (completedLessons.includes("Resonance")) {
      setIsCompleted(true);
    }
  }, [completedLessons]);

  const handleMarkAsCompleted = () => {
    setLessonCompleted("Resonance");
    setIsCompleted(true);
    setIsLocked(false);
  };
  ...
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        {!isLocked && (
          <TouchableOpacity onPress={() => navigation.navigate("PutBasic")}>
            <View style={styles.card}>
              ...
              <View style={styles.cardContent}>
                <Text style={styles.cardTitle}>Put Basics Together</Text>
