...
const PutEverythingThankyouScreen = ({ navigation }) => {
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate("PutEverythingHomework")}>
...
export default PutEverythingThankyouScreen;
